...
{
	iki_relocate(dp, "xsim.dir/tb_reset_during_read_func_synth/xsim.reloc",  (void **)funcTab, 173);
	iki_vhdl_file_variable_register(dp + 633768);
	iki_vhdl_file_variable_register(dp + 633824);
...
{
	iki_sensitize(dp, "xsim.dir/tb_reset_during_read_func_synth/xsim.reloc");
}
...
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/tb_reset_during_read_func_synth/xsim.reloc");
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/tb_reset_during_read_func_synth/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/tb_reset_during_read_func_synth/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/tb_reset_during_read_func_synth/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
