...
{
	iki_relocate(dp, "xsim.dir/project_tb_03_func_synth/xsim.reloc",  (void **)funcTab, 132);
	iki_vhdl_file_variable_register(dp + 614992);
	iki_vhdl_file_variable_register(dp + 615048);
