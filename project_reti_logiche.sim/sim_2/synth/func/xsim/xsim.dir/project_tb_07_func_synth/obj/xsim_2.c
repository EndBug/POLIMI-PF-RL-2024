...
{
	iki_relocate(dp, "xsim.dir/project_tb_07_func_synth/xsim.reloc",  (void **)funcTab, 177);
	iki_vhdl_file_variable_register(dp + 634192);
	iki_vhdl_file_variable_register(dp + 634248);
