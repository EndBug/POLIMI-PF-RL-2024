...
{
	iki_relocate(dp, "xsim.dir/project_tb_05_func_synth/xsim.reloc",  (void **)funcTab, 177);
	iki_vhdl_file_variable_register(dp + 631600);
	iki_vhdl_file_variable_register(dp + 631656);
