...
{
	iki_relocate(dp, "xsim.dir/project_tb_06_func_synth/xsim.reloc",  (void **)funcTab, 134);
	iki_vhdl_file_variable_register(dp + 615296);
	iki_vhdl_file_variable_register(dp + 615352);
