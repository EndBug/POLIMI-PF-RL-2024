...
{
	iki_relocate(dp, "xsim.dir/project_tb_08_func_synth/xsim.reloc",  (void **)funcTab, 134);
	iki_vhdl_file_variable_register(dp + 629776);
	iki_vhdl_file_variable_register(dp + 629832);
