...
{
	iki_relocate(dp, "xsim.dir/project_tb_04_func_synth/xsim.reloc",  (void **)funcTab, 132);
	iki_vhdl_file_variable_register(dp + 614768);
	iki_vhdl_file_variable_register(dp + 614824);
