...
{
	iki_relocate(dp, "xsim.dir/gen9_func_synth/xsim.reloc",  (void **)funcTab, 177);
	iki_vhdl_file_variable_register(dp + 631408);
	iki_vhdl_file_variable_register(dp + 631464);
